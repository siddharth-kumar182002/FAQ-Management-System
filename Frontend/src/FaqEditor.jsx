...
const FaqEditor = () => {
  ...
  const handleAddFAQ = async () => {
    try {
      const response = await fetch('https://faq-management-system-backend.onrender.com/api/faqs', {
        method: 'POST',
        headers: {
  ...
  const handleSave = async (id) => {
    try {
      const response = await fetch(`https://faq-management-system-backend.onrender.com/api/faqs/${id}`, {
        method: 'PUT',
